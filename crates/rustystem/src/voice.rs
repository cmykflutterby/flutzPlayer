...
impl Voice {
    ...
    pub(crate) fn memory_debug_bytes(&self) -> usize {
    ...
    pub(crate) fn program(&self) -> i32 {
        self.program
    }

    pub(crate) fn bank(&self) -> i32 {
        self.bank
    }
    ...
    pub(crate) fn volume_envelope_stage(&self) -> EnvelopeStage {
        self.vol_env.stage()
    }

    pub(crate) fn volume_envelope_value(&self) -> f32 {
